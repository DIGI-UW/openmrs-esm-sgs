...
![Node.js CI](https://github.com/I-TECH-UW/openmrs-esm-sgs/actions/workflows/ci.yml/badge.svg)

# SGS O3 Monorepo

This repository contains frontend modules for O3, specific to the requirements of the SGS distribution.

Check out the developer documentation [here](https://om.rs/3devdocs).
...
This command uses the [openmrs](https://www.npmjs.com/package/openmrs) tooling to fire up a dev server running the specified module.
...
The `main` branch of this repo is deployed in a [demo environment](https://dev3.openmrs.org/openmrs/spa).
...
[draft a new release](https://github.com/i-tech-uw/openmrs-esm-sgs/releases/new).
